...
(function () {
  ...
  //     if (lang == "en") {
  //       document.getElementById("header-lang-img").src = "static/super_admin/assets/images/flags/us.svg";
  //     } else if (lang == "sp") {
  //       document.getElementById("header-lang-img").src = "static/super_admin/assets/images/flags/spain.svg";
  //     } else if (lang == "gr") {
  //       document.getElementById("header-lang-img").src = "static/super_admin/assets/images/flags/germany.svg";
  //     } else if (lang == "it") {
  //       document.getElementById("header-lang-img").src = "static/super_admin/assets/images/flags/italy.svg";
  //     } else if (lang == "ru") {
  //       document.getElementById("header-lang-img").src = "static/super_admin/assets/images/flags/russia.svg";
  //     }
  ...
  //   request.open("GET", "static/super_admin/assets/lang/" + language + ".json");
  ...
  // function get_hebrew_translations(){
  //   let link = $("#translations_url_call_").val();
  ...
  //               // Other data to send in the request
  //         },
  //         dataType:'JSON',
