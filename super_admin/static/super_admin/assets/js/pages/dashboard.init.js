...
// var myModel = document.querySelector("#myModal").classList;
// document.querySelector("#modelOver").addEventListener("click", () => {
//     // myModel.re
//     myModel.add('hidden');
//     document.querySelector("#modelOver").classList.add('hidden')
// });
